...
# Note: Using regular BatchNormalization instead of QBatchNormalization due to
# Keras 3.x compatibility issues. This is acceptable because:
# 1. HLS4ml will fuse BatchNormalization with the preceding Conv layer
# 2. The fused operation will be quantized based on the Conv quantizers
